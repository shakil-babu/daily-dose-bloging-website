...
const ExpressDetails = (props) => {
    const {postId} = useParams();
    const FindPost = expressjsPost.find((item) => item.id === postId);
    return (
        <>
            <section className="express-details-area">
                ...
                <div className="underline"></div>
                    ...
                    <div className="about-category py-5 px-3">
                        <About/>
                        <Category/>
                        <RelatedPost language='Express.js' ID={FindPost.id}/>
                        <NewsLetter/>
                    </div>
                </div>
                </div>
