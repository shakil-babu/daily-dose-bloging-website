...
const NodeJsDetails = (props) => {
    const {postId} = useParams();
    const FindPost = nodejsPost.find((item) => item.id === postId);
    return (
        <>
            <section className="node-js-details-area">
                ...
                <div className="underline"></div>
                    ...
                    <div className="about-category py-5 px-3">
                        <About/>
                        <Category/>
                        <RelatedPost language='Node.js' ID={FindPost.id} />
                        <NewsLetter/>
                    </div>
                </div>
                </div>
